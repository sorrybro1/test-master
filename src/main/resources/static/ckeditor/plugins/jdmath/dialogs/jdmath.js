CKEDITOR.dialog.add("jdmath", function (a) {
    ...
    return {
        ...
        onOk: function () {
           ...
           // document.getElementById(jme_fid).contentWindow.document.getElementsByName('latex')[0].value="";
            //document.getElementById(jme_fid).contentWindow.document.getElementById('jme-math').innerHTML='<span class="mq-textarea"><textarea autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false" x-palm-disable-ste-all="true"></textarea></span><span class="mq-root-block mq-empty" mathquill-block-id="1"></span>';
            //window.location.href='plugins/jdmath/dialogs/jdmath.html';
           // window.location.reload();
           // document.jme_fid=location.href ;
            return true;
        }
    }
});
